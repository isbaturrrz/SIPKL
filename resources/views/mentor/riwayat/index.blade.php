...
<head>
    ...
    <style>
        ...
        .search-box input:focus, .filter-box input:focus, .filter-box select:focus {
            border-color: #2c5aa0;
                ...
                <div class="container-fluid">
                    ...
                    <div class="table-card">
                        ...
                        <div style="padding: 1.5rem 2rem;">
                            <form method="GET" action="{{ route('mentor.riwayat.index') }}" id="filterForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="filter-box">
                                            ...
                                            <select name="kehadiran" id="kehadiranFilter">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style="display: flex; gap: 0.75rem;">
                                            ...
                                            @if(request('tanggal') || request('kehadiran'))
