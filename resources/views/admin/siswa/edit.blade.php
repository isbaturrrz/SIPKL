...
<body id="page-top">
    <div id="page-loader">
        ...
        <div class="loader-text">Memuat Form Edit Siswa...</div>
    </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.siswa.update', $siswa->id_siswa) }}" method="POST" id="siswaForm">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nipd') is-invalid @enderror" 
                                                id="nipd" name="nipd" value="{{ old('nipd', $siswa->nipd) }}" 
                                            ...
                                            @enderror
                                            <small class="form-text text-muted">NIPD hanya boleh berisi angka</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror" 
                                                ...
                                                value="{{ old('tgl_lahir', $siswa->tgl_lahir ? $siswa->tgl_lahir->format('Y-m-d') : '') }}" 
                                                required>
                                            @error('tgl_lahir')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('kelas') is-invalid @enderror" 
                                                ...
                                                @foreach(\App\Models\Siswa::KELAS_LIST as $kls)
                                                    <option value="{{ $kls }}" 
                                                            {{ (old('kelas') ?? $siswa->kelas) == $kls ? 'selected' : '' }}>
                                                        {{ $kls }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('jurusan') is-invalid @enderror" 
                                                ...
                                                @foreach(\App\Models\Siswa::JURUSAN_LIST as $kode => $nama)
                                                    <option value="{{ $kode }}" 
                                                            {{ (old('jurusan') ?? $siswa->jurusan) == $kode ? 'selected' : '' }}>
                                                        {{ $kode }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('rombel') is-invalid @enderror" 
                                                id="rombel" name="rombel" value="{{ old('rombel', $siswa->rombel) }}" 
                                ...
                                <div class="row">
                                            ...
                                            <select class="form-control @error('id_instansi') is-invalid @enderror" 
                                                ...
                                                @foreach($instansi as $i)
                                                    <option value="{{ $i->id_instansi }}" 
                                                        {{ (old('id_instansi') ?? $siswa->id_instansi) == $i->id_instansi ? 'selected' : '' }}
                                                        {{ ($i->kuota_terpakai >= $i->kuota_siswa && $i->id_instansi != $siswa->id_instansi) ? 'disabled' : '' }}>
                                                        {{ $i->nama_instansi }}
                                                        (Kuota: {{ $i->kuota_terpakai }}/{{ $i->kuota_siswa }})
                                                        @if($i->kuota_terpakai >= $i->kuota_siswa && $i->id_instansi != $siswa->id_instansi)
                                                            - PENUH
                                                        @endif
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Guru Pembimbing Saat Ini</label>
                                            <input type="text" class="form-control bg-light" 
                                                   value="{{ $siswa->guru->nama ?? 'Belum ada guru pembimbing' }}" 
                                                   readonly>
                                            <small class="form-text text-muted">Ditentukan otomatis dari instansi</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror" 
                                                ...
                                                value="{{ old('tanggal_mulai', $siswa->tanggal_mulai ? $siswa->tanggal_mulai->format('Y-m-d') : '') }}">
                                            @error('tanggal_mulai')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror" 
                                                ...
                                                value="{{ old('tanggal_selesai', $siswa->tanggal_selesai ? $siswa->tanggal_selesai->format('Y-m-d') : '') }}">
    ...
    <script>
        ...
        document.getElementById('btnUpdate').addEventListener('click', function(e) {
            ...
            const instansiText = instansiSelect.options[instansiSelect.selectedIndex]?.text || 'Tidak ada instansi';
