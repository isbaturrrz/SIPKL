                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror" 
                                                id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir', $siswa->tgl_lahir) }}" required>
                                            @error('tgl_lahir')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('kelas') is-invalid @enderror" 
                                                id="kelas" name="kelas" value="{{ old('kelas', $siswa->kelas) }}" 
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('jurusan') is-invalid @enderror" 
                                                id="jurusan" name="jurusan" value="{{ old('jurusan', $siswa->jurusan) }}" 
                                            ...
                                            <select class="form-control @error('id_guru') is-invalid @enderror" 
                                                ...
                                                @foreach($guru as $g)
                                                    <option value="{{ $g->id_guru }}" 
                                                        {{ old('id_guru', $siswa->id_guru) == $g->id_guru ? 'selected' : '' }}>
                                                        {{ $g->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
