...
<body id="page-top">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.siswa.store') }}" method="POST" id="siswaForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_instansi" id="id_instansi" class="form-control @error('id_instansi') is-invalid @enderror">
    ...
    <script>
        ...
        document.getElementById('btnSubmit').addEventListener('click', function(e) {
            ...
            if (!nipd || !nama || !tempatLahir || !tglLahir || !noHp || !kelas || !jurusan || !alamat) {
                Swal.fire({
                    icon: 'error',
            ...
            const confirmHTML = `
                <div style="padding: 0.5rem 0;">
                    ...
                    <h3 style="font-size: 1.25rem; font-weight: 700; color: #1a1a1a; margin-bottom: 0.5rem;">Konfirmasi Tambah Siswa</h3>
                    <p style="font-size: 0.9rem; color: #64748b; margin-bottom: 1rem;">Apakah Anda yakin ingin menambahkan data siswa berikut?</p>
