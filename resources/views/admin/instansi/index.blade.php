...
<body id="page-top">
    <div id="page-loader">
        ...
        <div class="loader-text">Memuat Data Instansi...</div>
    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.btn-delete').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                const pemilik = form.getAttribute('data-pemilik');
                const alamat = form.getAttribute('data-alamat');
                const kuota = form.getAttribute('data-kuota');
                const jumlahSiswa = parseInt(form.getAttribute('data-siswa'));
                ...
                if (jumlahSiswa > 0) {
                    const errorHTML = `
                        <div style="padding: 0.5rem 0;">
                            ...
                            <p style="font-size: 0.9rem; color: #64748b; margin-bottom: 1rem;">Instansi ini tidak dapat dihapus karena masih memiliki siswa aktif.</p>
                            ...
                            <div style="background: #f8fafc; padding: 1rem; border-radius: 8px; text-align: left;">
                                <table style="width: 100%; font-size: 0.85rem;">
                                    ...
                                    <tr>
                                        <td style="padding: 0.4rem 0; color: #64748b; font-weight: 600;">Jumlah Siswa:</td>
                                        <td style="padding: 0.4rem 0; color: #dc2626; font-weight: 700;">${jumlahSiswa} Siswa Aktif</td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    const confirmHTML = `
                        <div style="padding: 0.5rem 0;">
                            <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #fee2e2 0%, #fecaca 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem;">
                                <i class="fas fa-building" style="font-size: 1.75rem; color: #dc2626;"></i>
                            </div>
                            <h3 style="font-size: 1.25rem; font-weight: 700; color: #1a1a1a; margin-bottom: 0.5rem;">Konfirmasi Hapus Instansi</h3>
                            <p style="font-size: 0.9rem; color: #64748b; margin-bottom: 1rem;">Apakah Anda yakin ingin menghapus instansi berikut?</p>
                            ...
                            <div style="background: #f8fafc; padding: 1rem; border-radius: 8px; text-align: left;">
                                <table style="width: 100%; font-size: 0.85rem;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 0.4rem 0; color: #1a1a1a; font-weight: 700;">${alamat}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0.4rem 0; color: #64748b; font-weight: 600;">Kuota:</td>
                                        <td style="padding: 0.4rem 0; color: #1a1a1a; font-weight: 700;">${kuota}</td>
                                    </tr>
                                </table>
                            </div>
