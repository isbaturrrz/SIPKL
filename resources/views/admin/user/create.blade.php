...
<body id="page-top">
    <div id="page-loader">
        ...
        <div class="loader-text">Memuat Form Tambah User...</div>
    </div>
    ...
    <script>
        ...
        if (btnSubmit) {
            btnSubmit.addEventListener('click', function(e) {
                ...
                if (!name || !username || !email || !roleValue || !password || !passwordConfirm) {
                    Swal.fire({
                        icon: 'error',
                ...
                const confirmHTML = `
                    <div style="padding: 0.5rem 0;">
                        <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem;">
                            <i class="fas fa-user-plus" style="font-size: 1.75rem; color: #10b981;"></i>
                        </div>
                        <h3 style="font-size: 1.25rem; font-weight: 700; color: #1a1a1a; margin-bottom: 0.5rem;">Konfirmasi Tambah User</h3>
                        <p style="font-size: 0.9rem; color: #64748b; margin-bottom: 1rem;">Apakah Anda yakin ingin menambahkan user berikut?</p>
                        ...
                        <div style="background: #f8fafc; padding: 1rem; border-radius: 8px; text-align: left;">
                            <table style="width: 100%; font-size: 0.85rem;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0.4rem 0; color: #1a1a1a; font-weight: 700;">${escapeHtml(username)}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 0.4rem 0; color: #64748b; font-weight: 600;">Email:</td>
                                    <td style="padding: 0.4rem 0; color: #1a1a1a; font-weight: 700;">${escapeHtml(email)}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 0.4rem 0; color: #64748b; font-weight: 600;">Role:</td>
                                    <td style="padding: 0.4rem 0; color: #1a1a1a; font-weight: 700;">${escapeHtml(roleText)}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 0.4rem 0; color: #64748b; font-weight: 600;">Password:</td>
                                    <td style="padding: 0.4rem 0; color: #1a1a1a; font-weight: 700;">●●●●●●●●</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div style="background: #d1fae5; border-left: 4px solid #10b981; padding: 0.65rem 1rem; border-radius: 8px; margin-top: 1rem;">
                            <p style="font-size: 0.8rem; color: #065f46; margin: 0; font-weight: 600;">
                                ...
                                User akan memiliki akses sesuai role yang dipilih
                            </p>
                        </div>
                    </div>
                `;
