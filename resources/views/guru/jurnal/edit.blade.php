        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="{{ route('guru.jurnal.update', $jurnal->id_jurnal) }}" id="jurnalForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-card">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    @enderror
                                    <small class="text-muted">Pilih siswa yang akan diupdate jurnalnya</small>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Pilih tanggal jurnal</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-card" id="kegiatanCard">
                            ...
                            <textarea name="kegiatan" 
                                      ...
                                      placeholder="Tuliskan kegiatan yang dilakukan siswa pada hari tersebut...">{{ old('kegiatan', $jurnal->kegiatan) }}</textarea>
                            @error('kegiatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-card" id="manfaatCard">
                            ...
                            <textarea name="manfaat" 
                                      ...
                                      placeholder="Tuliskan manfaat atau pembelajaran yang didapat siswa dari kegiatan tersebut...">{{ old('manfaat', $jurnal->manfaat) }}</textarea>
                            @error('manfaat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-card" id="fotoCard">
                            ...
                            <div class="current-photo">
                                <p class="mb-2 font-weight-bold text-muted">Foto Saat Ini:</p>
                                <img src="{{ asset('storage/' . $jurnal->foto_kegiatan) }}" alt="Foto Kegiatan">
                                <small class="d-block mt-2 text-muted">
                                    <i class="fas fa-info-circle"></i> Upload foto baru untuk mengganti foto yang ada
                                </small>
                            </div>
                            @endif
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button type="button" id="btnUpdate" class="btn btn-primary-custom btn-action">
                ...
                if (fotoKegiatan > 0) {
                    confirmHTML += `
                            <tr>
                                ...
                                <td style="padding: 0.4rem 0; color: #10b981; font-weight: 700;"><i class="fas fa-check-circle"></i> Terlampir (Baru)</td>
                            </tr>`;
                }
            }
