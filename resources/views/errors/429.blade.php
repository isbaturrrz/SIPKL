    ...
    <div class="container">
        <div class="detective">
            <svg class="detective-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <!-- Mystery Man Character - Too Many Requests (429) -->
                ...
                <!-- Tangan kiri (memegang speedometer/alat pengukur kecepatan) -->
                ...
                <!-- Speedometer / alat pengukur rate limit di tangan kiri -->
                <g transform="translate(22, 98) rotate(-10)">
                    <!-- Lingkaran speedometer -->
                    <circle cx="0" cy="0" r="16" fill="none" stroke="#D4A017" stroke-width="2.5"/>
                    <circle cx="0" cy="0" r="13" fill="rgba(0,0,0,0.3)"/>
                    <!-- Jarum speedometer (menunjuk ke merah - terlalu cepat) -->
                    <line x1="0" y1="0" x2="10" y2="-8" stroke="#FF0000" stroke-width="2" stroke-linecap="round"/>
                    <circle cx="0" cy="0" r="2" fill="#D4A017"/>
                    <!-- Skala merah (batas atas) -->
                    <path d="M 8 -12 A 15 15 0 0 1 14 -2" stroke="#FF0000" stroke-width="2" fill="none"/>
                    <!-- Skala hijau (aman) -->
                    <path d="M -12 -8 A 15 15 0 0 1 -4 -14" stroke="#00FF00" stroke-width="2" fill="none"/>
                    <!-- Skala kuning (warning) -->
                    <path d="M -4 -14 A 15 15 0 0 1 8 -12" stroke="#FFD700" stroke-width="2" fill="none"/>
                </g>
                
                <!-- Tangan kanan (memegang plang LIMIT EXCEEDED) -->
                ...
                <!-- Plang "LIMIT EXCEEDED" (warna peringatan) -->
                <rect x="128" y="90" width="70" height="34" rx="4" fill="#FF8C00" stroke="#CC7000" stroke-width="2" transform="rotate(6 163 107)"/>
                <text x="163" y="106" font-size="6.5" fill="white" text-anchor="middle" font-weight="bold" font-family="monospace" transform="rotate(6 163 107)">LIMIT</text>
                <text x="163" y="116" font-size="6.5" fill="white" text-anchor="middle" font-weight="bold" font-family="monospace" transform="rotate(6 163 107)">EXCEEDED</text>
                
                <!-- Simbol peringatan segitiga dengan tanda seru di atas plang -->
                <g transform="translate(163, 82) rotate(6)">
                    <polygon points="0,-10 -8,6 8,6" fill="#FF0000" stroke="#CC0000" stroke-width="1.5"/>
                    <text x="0" y="3" font-size="8" fill="white" text-anchor="middle" font-weight="bold">!</text>
                </g>
                
                <!-- Efek kelelahan/lelah (garis-garis di wajah) -->
                <!-- Keringat di dahi -->
                <path d="M 115 62 Q 118 60 120 63" stroke="#87CEEB" stroke-width="1.5" fill="none" opacity="0.7"/>
                <path d="M 118 58 Q 121 56 123 59" stroke="#87CEEB" stroke-width="1.5" fill="none" opacity="0.5"/>
            </svg>
        </div>

        <div class="error-code">429</div>
        
        <h1>🚦 Terlalu Banyak Permintaan - Rate Limit Tercapai</h1>
        
        <p>
            Wah, sepertinya Anda terlalu bersemangat! 🔥<br>
            Anda sudah mengirim terlalu banyak permintaan dalam waktu singkat. 
            Istirahat sejenak, minum kopi ☕, lalu coba lagi nanti.
        </p>
