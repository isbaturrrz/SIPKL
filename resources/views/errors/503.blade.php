...
<head>
    ...
    <style>
        * {
        ...
        .btn-refresh:active, .btn-home:active {
    ...
    <div class="container">
        <div class="detective">
            <svg class="detective-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <!-- Mystery Man Character - Service Unavailable (503) -->
                ...
                <!-- Tangan kiri (memegang papan "SEDANG TIDUR / OFFLINE") -->
                ...
                <!-- Simbol server tidur/offline (Zzz) di tangan kiri -->
                <g transform="translate(20, 90) rotate(-10)">
                    <!-- Server rack yang dimatikan -->
                    <rect x="-10" y="-12" width="20" height="24" rx="2" fill="#2C2C3E" stroke="#4A4A5E" stroke-width="1.5"/>
                    <!-- Lampu indikator mati -->
                    <circle cx="-5" cy="-7" r="2" fill="#FF0000" opacity="0.3"/>
                    <circle cx="0" cy="-7" r="2" fill="#FF0000" opacity="0.3"/>
                    <circle cx="5" cy="-7" r="2" fill="#FF0000" opacity="0.3"/>
                    <!-- Tombol power OFF -->
                    <circle cx="0" cy="5" r="4" fill="none" stroke="#FF0000" stroke-width="1.5" opacity="0.5"/>
                    <line x1="0" y1="1" x2="0" y2="5" stroke="#FF0000" stroke-width="1.5" opacity="0.5"/>
                    <!-- Zzz (tidur) -->
                    <text x="12" y="-8" font-size="6" fill="#87CEEB" font-weight="bold" opacity="0.8">Z</text>
                    <text x="16" y="-12" font-size="5" fill="#87CEEB" font-weight="bold" opacity="0.6">z</text>
                    <text x="19" y="-15" font-size="4" fill="#87CEEB" font-weight="bold" opacity="0.4">z</text>
                </g>
                
                <!-- Tangan kanan (memegang plang MAINTENANCE) -->
                ...
                <!-- Plang "MAINTENANCE" (warna biru tua - sedang perbaikan) -->
                <rect x="122" y="88" width="82" height="34" rx="4" fill="#1E3A5F" stroke="#0F2440" stroke-width="2" transform="rotate(7 163 105)"/>
                <text x="163" y="104" font-size="6" fill="#FFD700" text-anchor="middle" font-weight="bold" font-family="monospace" transform="rotate(7 163 105)">MAINTENANCE</text>
                <text x="163" y="114" font-size="6" fill="#87CEEB" text-anchor="middle" font-weight="bold" font-family="monospace" transform="rotate(7 163 105)">MODE</text>
                
                <!-- Simbol alat perbaikan (kunci inggris) di atas plang -->
                <g transform="translate(163, 80) rotate(7)">
                    <!-- Kunci inggris -->
                    <rect x="-6" y="-3" width="12" height="4" rx="1" fill="#D4A017"/>
                    <circle cx="-6" cy="-1" r="4" fill="none" stroke="#D4A017" stroke-width="2"/>
                    <circle cx="-6" cy="-1" r="2" fill="#1E3A5F"/>
                </g>
                
                <!-- Wajah tampak santai/sabar (lagi nunggu) -->
                <!-- Mata setengah tertutup (ngantuk) -->
                <path d="M 86 71 Q 92 74 98 71" stroke="#2C2C2C" stroke-width="1.5" fill="none"/>
                <path d="M 102 71 Q 108 74 114 71" stroke="#2C2C2C" stroke-width="1.5" fill="none"/>
                
                <!-- Senyum sabar -->
                <path d="M 93 84 Q 100 87 107 84" stroke="#6A4A3A" stroke-width="1.5" fill="none" stroke-linecap="round"/>
                
                <!-- Baret/baret di pipi (menunggu) -->
                <circle cx="85" cy="80" r="3" fill="#FDBCB4" stroke="#D4947C" stroke-width="0.5"/>
            </svg>
        </div>

        <div class="error-code">503</div>
        
        <h1>🔧 Layanan Sedang Tidur - Maintenance Mode</h1>
        
        <p>
            Server kami sedang istirahat atau dalam perawatan. 😴<br>
            Seperti detektif yang butuh kopi, server kami sedang di-upgrade.
            Coba lagi nanti ya! ☕🔧
        </p>

        <div class="button-group">
            <a href="javascript:location.reload()" class="btn-refresh">🔄 Coba Lagi Nanti</a>
            <a href="/" class="btn-home">🏠 Kembali ke Markas</a>
        </div>
    </div>
