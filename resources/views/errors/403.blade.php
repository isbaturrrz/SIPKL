...
<head>
    ...
    <style>
        * {
        ...
        .btn-home:active, .btn-contact:active {
    ...
    <div class="container">
        <div class="detective">
            <svg class="detective-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <!-- Mystery Man Character - Forbidden Access -->
                ...
                <!-- Plang "DILARANG" / "FORBIDDEN" -->
                <rect x="145" y="100" width="45" height="30" rx="4" fill="#8B0000" stroke="#6B0000" stroke-width="2" transform="rotate(15 167 115)"/>
                <text x="167" y="120" font-size="8" fill="white" text-anchor="middle" font-weight="bold" transform="rotate(15 167 115)">FORBIDDEN</text>
                
                <!-- Garis miring merah (tanda dilarang) di atas plang -->
                <line x1="148" y1="103" x2="187" y2="127" stroke="#FF0000" stroke-width="3" opacity="0.8" transform="rotate(15 167 115)"/>
            </svg>
        </div>

        <div class="error-code">403</div>
        
        <h1>⛔ Akses Dilarang - Area Terkunci</h1>
        
        <p>
            Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. <br>
            Ini bukan soal kredensial yang salah, tapi area ini memang ditutup untuk umum 🕵️‍♂️.
        </p>
